...
//		closest_frequency = gpioHardwarePWM(18, 0,500000);
	...
	while(1){
		...
		for(int i=0;i<freq_up_cnt;i++){
			closest_frequency = gpioHardwarePWM(18, x+freq_up,500000);
			Get = gpioGetPWMfrequency(18);
//			printf("freq: %d\n",Get);
//			closest_frequency = gpioHardwarePWM(19, 500+freq_up,500000);
//			closest_frequency = gpioHardwarePWM(12, 500+freq_up,500000);
			if(i<freq_up_cnt){
				usleep(10000);	//10ms
